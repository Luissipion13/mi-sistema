...
const FilterBar = ({ filters, onFilter, onClear }) => (
    ...
    <div style={{ display:"flex", flexWrap:"wrap", gap:12, alignItems:"flex-end" }}>
      {filters.map((f, i) => (
        <div key={i} style={{ display:"flex", flexDirection:"column", gap:4 }}>
          ...
          {f.type === "select" ? (
            <select style={{ padding:"6px 10px", border:"1px solid #ccc", borderRadius:4, fontSize:12, minWidth:130 }}>
              {f.options.map((o,j) => <option key={j}>{o}</option>)}
            </select>
          ) : (
            <input placeholder={f.placeholder||""} style={{ padding:"6px 10px", border:"1px solid #ccc", borderRadius:4, fontSize:12, width: f.width || 120 }} />
          )}
        </div>
      ))}
      <div style={{ display:"flex", gap:8, marginLeft:"auto" }}>
        <button onClick={onFilter} style={{ padding:"8px 18px", background:"#2c3e6b", color:"#fff", border:"none", borderRadius:4, cursor:"pointer", fontSize:12, fontWeight:600, display:"flex", alignItems:"center", gap:4 }}>
          🔍 Buscar
        </button>
...
const ActuacionesPage = () => {
  ...
  return (
    <div>
      ...
      <FilterBar
        filters={[
          { label:"Año", type:"input", width:70, placeholder:"2026" },
          { label:"Tipo Bien", type:"select", options:["(TODOS)","B","S"] },
          { label:"Tipo Contratación", type:"select", options:["(TODOS)","ASP BIENES Y SERVICIOS","TERCEROS","OTROS - DIFERENTE A ASP","ACUERDO MARCO - BIENES"] },
          { label:"N° Orden", type:"input", width:110 },
          { label:"Concepto", type:"input", width:150 },
          { label:"RUC", type:"input", width:100 },
          { label:"Proveedor", type:"input", width:140 },
          { label:"N° Exp. SIAF", type:"input", width:100 },
          { label:"Usuario SIGA", type:"select", options:["(TODOS)"] },
        ]}
      />
      <div style={{ marginBottom:8, display:"flex", gap:16, fontSize:11.5, color:"#555" }}>
        <span>LEYENDA:</span>
  ...
  return (
    <div>
      ...
      <FilterBar
        filters={[
          { label:"Año", type:"input", width:70, placeholder:"2026" },
          { label:"Centro de Costo", type:"select", options:["(TODOS)"] },
          { label:"Tipo Orden", type:"select", options:["(TODOS)","B","S"] },
          { label:"N° Orden", type:"input", width:110 },
          { label:"RUC", type:"input", width:100 },
          { label:"Proveedor", type:"input", width:140 },
          { label:"N° Exp. SIAF", type:"input", width:100 },
      ...
      />
      <div style={{ fontSize:12, fontWeight:600, color:"#2c3e6b", marginBottom:8, background:"#eef2f7", padding:"8px 12px", borderRadius:4 }}>LISTADO</div>
      <DataTable columns={columns} data={CONFORMIDADES_DATA} onRowClick={setSelectedConf}
    ...
    <div>
      ...
      <FilterBar
        filters={[
          { label:"Año", type:"input", width:70, placeholder:"2026" },
          { label:"Tipo Bien", type:"select", options:["(TODOS)","B","S"] },
          { label:"Tipo Contratación", type:"select", options:["(TODOS)","ASP BIENES Y SERVICIOS","TERCEROS","OTROS - DIFERENTE A ASP"] },
          { label:"N° Orden", type:"input", width:110 },
          { label:"Concepto", type:"input", width:150 },
          { label:"RUC", type:"input", width:100 },
          { label:"Proveedor", type:"input", width:140 },
          { label:"N° Exp. SIAF", type:"input", width:100 },
          { label:"Usuario SIGA", type:"select", options:["(TODOS)"] },
          { label:"Modalidad Adquisición", type:"select", options:["(TODOS)"] },
          { label:"Estado Cronograma", type:"select", options:["(TODOS)"] },
        ]}
      />
      ...
      <div style={{ fontSize:12, fontWeight:600, color:"#2c3e6b", marginBottom:8, background:"#eef2f7", padding:"8px 12px", borderRadius:4 }}>LISTADO</div>
      <DataTable columns={columns} data={CONSTANCIAS_DATA}
...
const PagosPage = () => (
  <div>
    ...
    <div style={{ fontSize:12, fontWeight:600, color:"#2c3e6b", marginBottom:8, background:"#eef2f7", padding:"8px 12px", borderRadius:4 }}>LISTADO</div>
    <div style={{ textAlign:"center", padding:40, color:"#95a5a6", fontSize:14 }}>
